...
spistSIMPROF <- simprof(spistShared, num.expected=10, num.simulated=9, method.cluster='average', method.distance='euclidean', method.transform='identity', alpha=0.05, sample.orientation='column', silent=FALSE)
