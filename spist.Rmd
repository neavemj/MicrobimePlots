...
The Red Sea has the most samples and is a bit hard to see at this scale - I'll take a closer look at these reefs. We also collected some different Stylophora morphology types from the Red Sea reefs - one fatter fingered, reef-flat variatey and a thinner fingered, deeper variety. I decided to also facet out these morpho-types.
