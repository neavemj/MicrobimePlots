...
library("knitr")
#library("clustsig")
setwd("/home/neave/data/3.globalMicrobiome/3.mothur/2.poolsCombined/spist")
opts_knit$set(root.dir = "/home/neave/data/3.globalMicrobiome/3.mothur/2.poolsCombined/spist")
```
...
mothurNMDSspearman <- as.data.frame(read.table("micro.spist.0.03.braycurtis.spearman.corr.axes", header=T))
...
spistSIMPROF <- simprof(spistShared, num.expected=100, num.simulated=99, method.cluster='average', method.distance='euclidean', method.transform='identity', alpha=0.05, sample.orientation='column', silent=FALSE)
