...
microRich + geom_boxplot(data = microRich$data, aes(x = species, y = value, color = NULL), alpha = 0.1)
```
...
setwd('~/microbiome/subprojects/2.16S_MiSeq/2.data/3.mothur/5.mock9Nov14/')
...
hmpStaggered = read.table('HMP_staggeredEdit.txt', sep='\t', header=T)
