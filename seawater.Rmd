...
microSubRelFiltSeaEndoFilt = filter_taxa(microSubRelFiltSeaEndo, function(x) mean(x) > 1e-4, TRUE)

plot_bar(microSubRelFiltSeaEndoFilt, fill="catglab", title='seawater') +
